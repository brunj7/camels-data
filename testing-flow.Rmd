...
```{r camels}
# directories
my_basin_dir <- "~/Data/camels/basin_dataset_public_v1p2"
...
usgs_chem_q <- usgs_chem %>%
  ...
  select(MonitoringLocationIdentifier, ActivityStartDate, ActivityStartTime.Time, ActivityStartTime.TimeZoneCode,CharacteristicName, ResultMeasureValue, ResultMeasure.MeasureUnitCode) %>%
...
# Water Quality
write_csv(usgs_chem "data/usgs_waterq_test_sites.csv")
