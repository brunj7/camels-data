---
title: "camels-testing"
knit: (function(input_file, encoding) {
  out_dir <- 'docs';
  rmarkdown::render(input_file,
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, 'test_sites.html'))})
...
We selected few basins close to the gauges used in previous studies

```{r}
knitr::include_graphics("images/camels_test_sample.png")
```

  
## Getting CAMELS data for our test sites  
